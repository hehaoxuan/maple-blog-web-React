  ...
  routes: [
    {
      ...
      routes: [
        { path: '/blog', component: '@/pages/content/center' },
        { path: '/blog/:id', component: '@/pages/content/videoDetail' },
        { path: '/videoEdit/:id', component: '@/pages/content/editPage/index' },
        {
          path: '/upload',
          component: '@/pages/content/upload',
          wrappers: ['@/pages/content/upload/wrappers/auth'],
        },
        ...
        {
          path: '/changePassword',
          component: '@/pages/content/changePassword',
        },
